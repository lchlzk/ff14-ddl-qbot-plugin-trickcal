...
class BoardWebApiTests(unittest.TestCase):
    ...
    def test_page_state_individual_and_bulk_changes_share_bot_storage(self, fetch):
        ...
        self.assertIn("board.css?v=20260917-collection1", page.text)
        self.assertIn('id="openCollectionButton"', page.text)
        self.assertIn('id="collectionDialog"', page.text)
        self.assertIn('id="collectionGrid"', page.text)
